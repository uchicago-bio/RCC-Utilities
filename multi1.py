...
def execute(queryfile, databasefile, alignment, gappenalty, scoringmatrix, output):
...
if __name__ == '__main__':
	...
	p = Pool(1)
	p.apply(execute, [args.queryfile, args.databasefile, args.alignment, args.gappenalty, args.scoringmatrix, args.output])
